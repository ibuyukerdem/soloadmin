...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('soloaccounting', '0002_alter_usersite_site_sitemodule_delete_site'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('webServer', models.JSONField(blank=True, null=True, verbose_name='Web Sunucusu Bilgileri')),
                ('sqlServer', models.JSONField(blank=True, null=True, verbose_name='SQL Sunucusu Bilgileri')),
                ('mailServer', models.JSONField(blank=True, null=True, verbose_name='Mail Sunucusu Bilgileri')),
                ('dnsServer', models.JSONField(blank=True, null=True, verbose_name='DNS Sunucusu Bilgileri')),
                ('createdAt', models.DateTimeField(auto_now_add=True, verbose_name='Oluşturulma Tarihi')),
                ('updatedAt', models.DateTimeField(auto_now=True, verbose_name='Güncellenme Tarihi')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdAt', models.DateTimeField(auto_now_add=True, verbose_name='Oluşturulma Tarihi')),
                ('updatedAt', models.DateTimeField(auto_now=True, verbose_name='Güncellenme Tarihi')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mailServers', to='sites.site', verbose_name='Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdAt', models.DateTimeField(auto_now_add=True, verbose_name='Oluşturulma Tarihi')),
                ('updatedAt', models.DateTimeField(auto_now=True, verbose_name='Güncellenme Tarihi')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dnsServers', to='sites.site', verbose_name='Site')),
                ('operatingSystem', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='soloaccounting.operatingsystem', verbose_name='İşletim Sistemi')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatedAt', models.DateTimeField(auto_now=True, verbose_name='Güncellenme Tarihi')),
                ('operatingSystem', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='soloaccounting.operatingsystem', verbose_name='İşletim Sistemi')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sqlServers', to='sites.site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatedAt', models.DateTimeField(auto_now=True, verbose_name='Güncellenme Tarihi')),
                ('operatingSystem', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='soloaccounting.operatingsystem', verbose_name='İşletim Sistemi')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='webServers', to='sites.site', verbose_name='Site')),
            ],
        ),
    ]
